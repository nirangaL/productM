...
<head>
    ...
    <script src="<?php echo base_url()?>assets/global_assets/js/plugins/forms/validation/validate.min.js"></script>
...
<!--    <script src="--><?php //echo base_url()?><!--assets/global_assets/js/plugins/tables/datatables/datatables.min.js"></script>-->
   ...
   <!-- <script src="<?php echo base_url()?>assets/global_assets/js/plugins/tables/datatables/extensions/pdfmake/vfs_fonts.min.js"></script> -->
    ...
    <script src="<?php echo base_url()?>assets/global_assets/js/demo_pages/datatables_extension_buttons_html5.js"></script>
    <script src="<?php echo base_url()?>assets/global_assets/js/plugins/tables/datatables/extensions/fixed_columns.min.js"></script>
    ...
    <script src="<?php echo base_url()?>assets/global_assets/js/plugins/visualization/echarts/echarts.min.js"></script>
...
<!--    <script src="--><?php //echo base_url()?><!--assets/global_assets/js/demo_pages/charts/echarts/columns_waterfalls.js"></script>-->
        ...
        <ul class="navbar-nav">
                ...
                <div class="dropdown-menu dropdown-menu-right dropdown-content wmin-md-300">
                    ...
                    <div class="dropdown-content-body dropdown-scrollable">
                        <ul class="media-list">
                            <li class="media">
                                <div class="mr-3">
                                    <img src="<?php echo base_url()?>assets/global_assets/images/placeholders/placeholder.jpg" width="36" height="36" class="rounded-circle" alt="">
                                </div>
                                <div class="media-body">
            ...
            <li class="nav-item dropdown dropdown-user">
                <a href="#" class="navbar-nav-link dropdown-toggle" data-toggle="dropdown">
                    <img src="<?php echo base_url()?>assets/global_assets/images/placeholders/placeholder.jpg" class="rounded-circle" alt="">
                    <span><?php echo $_SESSION['session_user_data']['userName']?></span>
                </a>

                <div class="dropdown-menu dropdown-menu-right">
                    <a href="#" class="dropdown-item"><i class="icon-user-plus"></i> My profile</a>
                    <a href="<?php echo base_url('Welcome/logOut')?>" class="dropdown-item"><i class="icon-switch2" ></i> Logout</a>
                </div>
            </li>
        </ul>
    </div>

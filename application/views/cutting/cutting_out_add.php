  ...
  <div class="page-header page-header-light">
    <div class="page-header-content header-elements-md-inline">
      <div class="page-title d-flex">
        <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Cutting Out</span>
        </h4>
      ...
      <div class="header-elements d-none">
          ...
          <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
            <div class="d-flex">
              <div class="breadcrumb">
                ...
                <span class="breadcrumb-item active">Add Cut Data</span>
              </div>
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="col-sm-12 text-right" style="margin-top:20px;">
                <button class="btn btn-primary" onclick="addData();"><i class="icon-ungroup"></i> New Cut</button>
              </div>
            </div>
          </div>
          <!-- /card  -->
          ...
          <div class="modal-dialog modal-full">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title">Add New Cut </h5>
              ...
              <div class="modal-body">
                ...
                <div class="form-group row">
                  <label class="col-form-label col-sm-2">Cut Date :</label>
                  <div class="col-sm-2">
                  ...
                  <label class="col-form-label col-sm-2">Cut Number :</label>
                  <div class="col-sm-2">
        ...
        function getSeason(){
          ...
          if(style != ''){
            $("#error").empty();
            $.ajax({
              url: '<?php echo base_url("cutting/Cutting_Out_Con/getSeason")?>',
              type: "POST",
              data: ({
                'style': style,
              }),
        ...
        function getSavedData() {
          ...
          if (style != '') {
            $.ajax({
              url: '<?php echo base_url("cutting/Cutting_Out_Con/getSavedData")?>', //This is the current doc
              type: "POST",
              data: ({
                'style': style,
              }),
        ...
        function getRefNumber() {
          var style = $('#style').val();
          $.ajax({
            url: '<?php  echo base_url("cutting/Cutting_Out_Con/getRefNumber")?>',
            type: "POST",
            data: ({
              'style': style,
            }),
        ...
        function addData(){
          ...
          if(style != ''){
            ...
            $.ajax({
              url: '<?php echo base_url("cutting/Cutting_Out_Con/getStyleData") ?>', //This is the current doc
              type: "POST",
              data: ({
                'style': style,
              }),
              success: function (data) {
                if(data != ''){
                  ...
                  html += "<td><select id='color1' class='form-control select-search-tbl wid-150 color' data-placeholder='Select a color' onchange=''></select></td>";
                  for (var i = 0; i <json_value.length; i++) {
        ...
        function addLine(){
            ...
            html += "<td><select id='color"+(newRowNum)+"' class='form-control select-search-tbl wid-150 color' data-placeholder='Select a color' onchange=''></select></td>";
        ...
        function editData(id){
          ...
          if(id != ''){
            $.ajax({
              url: '<?php echo base_url("cutting/Cutting_Out_Con/editData") ?>', //This is the current doc
              type: "POST",
              data: ({
                'id': id,
              }),
              success: function (data) {
                ...
                for(var y = 0; y < poCount; y++){
                  html += "<tr id='tr"+(y+1)+"'>";
                  html += "<td><select id='delv"+(y+1)+"' class='form-control select-search-tbl wid-200 po' data-placeholder='Select a po' onchange='getColor(1)'><option value='"+json_value[y][0]['po']+"' selected >"+json_value[y][0]['po']+"</option></select></td>";
                  html += "<td><select id='color"+(y+1)+"' class='form-control select-search-tbl wid-150 color' data-placeholder='Select a color' onchange=''><option value='"+json_value[y][0]['color']+"' selected>"+json_value[y][0]['color']+"</option></select></td>";
                  var total = 0;
        ...
        function getDelivery(rowId) {
          ...
          if (style != '') {
            $.ajax({
              url: '<?php echo base_url("cutting/Cutting_Out_Con/getDelivery")?>', //This is the current doc
              type: "POST",
              data: ({
                'style': style,
              }),
        ...
        function getColor(rowId) {
          ...
          if(rowId!=''){
            ...
            if (style != '' &&  poAlreadySelect==false) {
              $.ajax({
                url: '<?php echo base_url("cutting/Cutting_Out_Con/getColor")?>', //This is the current doc
                type: "POST",
                data: ({
                  'style': style,
                  'delv': delv,
        ...
        //   if(style !=''  && delv !='' && color !=''){
        //     $.ajax({
        //       url: '<?php // echo base_url("cutting/Cutting_Out_Con/getOrderQtyEachSize")?>',
        //       type: "POST",
        //       data: ({
        //         'style': style,
        //         'delv': delv,
        ...
        function setData(){
          ...
          if (style != '' &&  date!='' && refNumber != '' && gridDataIsFill == true) {
            $.ajax({
              url: '<?php  echo base_url("cutting/Cutting_Out_Con/setData")?>', //This is the current doc
              type: "POST",
              data: ({
                'allData':data,
              }),
        ...
        function updateData(){
          ...
          if (style != '' &&  date!='') {
            $.ajax({
              url: '<?php  echo base_url("cutting/Cutting_Out_Con/updateData")?>', //This is the current doc
              type: "POST",
              data: ({
                'allData':data,
              }),

<div class="content-wrapper">
    ...
    <div class="page-header page-header-light">
        <div class="page-header-content header-elements-md-inline">
            <div class="page-title d-flex">
                <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Report</span> - Qc Pass Log
                </h4>
        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <span class="breadcrumb-item active">Qc Pass Log</span>
                </div>
                <a href="#" class="header-elements-toggle text-default d-md-none"><i class="icon-more"></i></a>
            </div>
    ...
    <div class="content">
        <div class="card">
            <div class="card-body">
               <form action="<?php echo base_url('report/Qc_passlog/getTableData');?>" method="post">
                   <div class="row">
    ...
    $(document).ready(function () {
        ...
        var date = currentDate.getDate() +'-'+(currentDate.getMonth()+1)+'-'+currentDate.getFullYear();
            ...
            $('#qcPassLogTbl tfoot th').each( function () {
                var title = $(this).text();
                $(this).html( '<input type="text" placeholder="  Search '+title+'" />' );
            } );

            var fileName  = 'Qc_Pass_Log ' + date;

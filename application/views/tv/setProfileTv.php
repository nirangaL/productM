        ...
        <div class="col-lg-8">
            <div class="card">
                <div class="card-body text-center">
                    ...
                    <form action="<?php echo base_url('Profile_App_Con/setCookies/').$wantToGo?>" method="post">
                        <fieldset class="lg-3">
        ...
        <div class="navbar navbar-expand-lg navbar-light">
            ...
            <div class="navbar-collapse collapse" id="navbar-footer">
					<span class="navbar-text">
						&copy; 2018 - <?php echo date('Y')?>. <a href="#">ProductM Web App Kit</a> by <a href="www.originalapparel.lk" target="_blank"> OAIT</a>
					</span>

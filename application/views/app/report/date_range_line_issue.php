    ...
    <div class="content">
        ...
        <div class="card">
            <div class="card-header header-elements-block text-center" style="padding-bottom: 0px;padding-top: 10px;">
              <div href="#" class="btn bg-transparent warning-400 text-warning-400  rounded-round border-2 btn-icon mr-2">
                <i class="icon-cart-remove"></i>
              </div><span class="title"><b> Line Issuing Between Date Range</b></span>
            </div>
            <div class="card-body">
              <fieldset class="mb-3">
                ...
                <div class="form-group row">
                  <div class="col-6">
                    ...
                    <div class="input-group">
                      ...
                      <input id="fromDate" type="text" class="form-control daterange-single form-control-lg" value="<?php echo date('mm/dd/Y',strtotime("-1 week"));?>" autocomplete="off" readonly>
                    </div>
                  </div>
                  <div class="col-6">
                    ...
                    <div class="input-group">
                      ...
                      <input id="toDate" type="text" class="form-control daterange-single form-control-lg" value="<?php echo date('mm/dd/Y');?>" autocomplete="off" readonly>
                    </div>
                  </div>
                </div>
                <div class="form-group row">
    ...
    <script type="text/javascript">
        ...
        function getData(){
            ...
            if(fromDate != '' && toDate!= ''){
              loaderOn();
                $.ajax({
                    url:'<?php echo base_url("app/report/Date_Range_Line_Issue_Con/getDateRangeWiseLineIssueReport")?>',
                    type:'POST',
                    data:{
                        'fromDate':fromDate,
                        'toDate':toDate,

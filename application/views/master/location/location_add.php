<div class="content-wrapper">
    ...
    <div class="content">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?php echo base_url('Location_Master_Con/saveLocation'); ?>" method="post">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>Location: <span class="text-danger">*</span></label>
                                <div class="col-md-4">
                                    <input type="text" name="name" id="name" value="" class="form-control" placeholder="Example (Pvt) Ltd" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <label>Address : <span class="text-danger">*</span></label>
                                <div class="col-md-4">
                                    <textarea name="address" id="address" rows="4" cols="4" class="form-control" required></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label>County: </label>
                                <div class="col-md-4">
                                    <select id="country" name="country" class="form-control select-search col-md-4"
                                        ...
                                        <?php foreach ($country as $row) {
                                            ?>
                                            <option value="<?php echo $row->id; ?>" <?php echo set_select('country', $row->id);?>  > <?php echo $row->country; ?> </option>
                                            <?php
                                        } ?>
                                    </select>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="input-group">
                                        ...
                                        <input id="phone" name="phone" type="number" value=""  class="form-control" maxlength="10"  placeholder="0111234567" required>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">

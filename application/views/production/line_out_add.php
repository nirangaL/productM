  ...
  <div class="page-header page-header-light">
    <div class="page-header-content header-elements-md-inline">
      <div class="page-title d-flex">
        <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Line Out</span>
        </h4>
      ...
      <div class="header-elements d-none">
          ...
          <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
            <div class="d-flex">
              <div class="breadcrumb">
                ...
                <span class="breadcrumb-item active">Line Out Data</span>
              </div>
          ...
          <div class="modal-dialog modal-full">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title">New Line Out </h5>
              ...
              <div class="modal-body">
                ...
                <div class="form-group row">
                  <label class="col-form-label col-sm-1">Line In Out :</label>
                  <div class="col-sm-3">
        ...
        function getSeason(){
          ...
          if(style != ''){
            $("#error").empty();
            $.ajax({
              url: '<?php echo base_url("production/Line_Out_Con/getSeason")?>',
              type: "POST",
              data: ({
                'style': style,
              }),
        ...
        function getSavedData() {
          ...
          if (style != '') {
            $.ajax({
              url: '<?php echo base_url("production/Line_Out_Con/getSavedData")?>', //This is the current doc
              type: "POST",
              data: ({
                'style': style,
              }),
        ...
        function getRefNumber() {
          var style = $('#style').val();
          $.ajax({
            url: '<?php  echo base_url("production/Line_Out_Con/getRefNumber")?>',
            type: "POST",
            data: ({
              'style': style,
            }),
        ...
        function addData(){
          ...
          if(style != ''){
            ...
            $.ajax({
              url: '<?php echo base_url("production/Line_Out_Con/getStyleData") ?>', //This is the current doc
              type: "POST",
              data: ({
                'style': style,
              }),
        ...
        function editData(id){
          ...
          if(id != ''){
            $.ajax({
              url: '<?php echo base_url("production/Line_Out_Con/editData") ?>', //This is the current doc
              type: "POST",
              data: ({
                'id': id,
              }),
        ...
        function getDelivery(rowId) {
          ...
          if (style != '') {
            $.ajax({
              url: '<?php echo base_url("production/Line_Out_Con/getDelivery")?>', //This is the current doc
              type: "POST",
              data: ({
                'style': style,
              }),
        ...
        function getColor(rowId) {
          ...
          if(rowId!=''){
            ...
            if (style != '' &&  poAlreadySelect==false) {
              $.ajax({
                url: '<?php echo base_url("production/Line_Out_Con/getColor")?>', //This is the current doc
                type: "POST",
                data: ({
                  'style': style,
                  'delv': delv,
        ...
        function getOrderQtyEachSize(rowNum){
          ...
          if(style !=''  && delv !='' && color !=''){
            $.ajax({
              url: '<?php  echo base_url("production/Line_Out_Con/getOrderQtyEachSize")?>',
              type: "POST",
              data: ({
                'style': style,
                'delv': delv,
        ...
        function setData(){
          ...
          var data = JSON.stringify(allData);
            ...
            if (gridDataIsFill == true) {
              $.ajax({
                url: '<?php  echo base_url("production/Line_Out_Con/setData")?>', //This is the current doc
                type: "POST",
                data: ({
                  'allData':data,
                }),
        ...
        function updateData(){
          ...
          if (style != '' &&  date!='') {
            $.ajax({
              url: '<?php  echo base_url("production/Line_Out_Con/updateData")?>', //This is the current doc
              type: "POST",
              data: ({
                'allData':data,
              }),

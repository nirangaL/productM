...
! function(n, e) {
    ...
    function i() {
        var n = document.body || document.documentElement,
            t = n.style,
            a = t.transition !== e || t.WebkitTransition !== e || t.MozTransition !== e || t.MsTransition !== e || t.OTransition !== e;
        return a
    }
    ...
    function r(e, t, a) {
        var r = 1 === e.character.length ? e.character : e.character.charAt(Math.round(o(0, e.character.length - 1))),
            ...
            f = { transform: "translateX(" + c + "px) translateY(" + m + "px) rotateZ(" + d + "deg)", opacity: 0 },
            h = n("<span></span>");
    ...
    function s(i, o) {
        function s() {
            o.useRelative === !0 && "static" === f.css("position") && f.css({ position: "relative" });
            var e = n(document.createElement("div")).addClass("flurry-container").css({ margin: 0, padding: 0, position: "absolute", top: 0, right: 0, left: 0, height: o.height, overflow: o.overflow, "pointer-events": "none" }).prependTo(f),
                a = e.width();
            n(window).resize(function() { a = e.width() }), d.flakeInterval = t(function() { r(o, e, a) }, o.frequency), m("onInit")
        }
        ...
        function m(n) { o[n] !== e && o[n].call(w) }
        var d = this,
            w = i,
            f = n(i);
        return o = n.extend({ height: f.height() > 200 ? 200 : f.height(), useRelative: f.is("body") ? !1 : !0 }, n.fn[c].defaults, o), n.each(o, function(n, e) { parseInt(e) && (o[n] = parseInt(e)) }), s(), { option: l, destroy: u }
    }! function() {
        ...
        window.requestAnimationFrame || (window.requestAnimationFrame = function(e, t) {
            var a = (new Date).getTime(),
                ...
                o = window.setTimeout(function() { e(a + i) }, i);
            return n = a + i, o
    ...
    n.fn[c] = function(t) {
        if ("string" == typeof arguments[0]) {
            ...
            return this.each(function() {
                if (!n.data(this, "plugin_" + c) || "function" != typeof n.data(this, "plugin_" + c)[i]) throw new Error("Method " + i + " does not exist on jQuery." + c);
                a = n.data(this, "plugin_" + c)[i].apply(this, o)
            }), a !== e ? a : this
        }
        return "object" != typeof t && t ? void 0 : this.each(function() { n.data(this, "plugin_" + c) || n.data(this, "plugin_" + c, new s(this, t)) })
    }, n.fn[c].defaults = { onInit: function() {}, onDestroy: function() {}, character: "❄", color: "white", frequency: 100, speed: 3e3, small: 8, large: 28, wind: 40, windVariance: 20, rotation: 90, rotationVariance: 180, startRotation: 0, startOpacity: 1, endOpacity: 0, opacityEasing: "cubic-bezier(1,.3,.6,.74)", blur: !0, overflow: "hidden", zIndex: 9999 }
}(jQuery);